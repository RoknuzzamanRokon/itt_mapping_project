    ...
    for hotel_id in hotel_id_list[:]:
        try:
            ...
            append_to_cannot_find_file(
                f"/var/www/VerVotech-Contents-Mapping/giata_mapping/static_file/cannot_find_{supplier_code}_hotel_id_list.txt",
                hotel_id
            )
            hotel_id_list.remove(hotel_id)
            write_tracking_file(file_path, hotel_id_list)
...
file_path = f"/var/www/VerVotech-Contents-Mapping/giata_mapping/static_file/{supplier_code}_supplier_hotel_id_list.txt"
